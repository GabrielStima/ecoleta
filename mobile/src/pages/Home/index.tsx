...
const Home: React.FC = () => {
  ...
  return (
    <ImageBackground source={require('../../assets/home-background.png')} style={styles.container} imageStyle={{width: 274, height: 368}}>
        ...
        <TextInput value={uf} maxLength={2} autoCapitalize="characters" autoCorrect={false} onChangeText={setUf} style={styles.input} placeholder="Digite a UF"></TextInput>
        <TextInput value={city} onChangeText={setCity} autoCorrect={false} style={styles.input} placeholder="Digite a Cidade"></TextInput>
